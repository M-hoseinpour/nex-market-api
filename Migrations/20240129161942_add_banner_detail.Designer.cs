...
namespace market.Migrations
{
    ...
    [Migration("20240129161942_add_banner_detail")]
    partial class add_banner_detail
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("market.Data.Domain.FileCategory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = (short)2,
                            Description = "All kind of documents, like identity or ownership documents. This files are private all the time",
            ...
            modelBuilder.Entity("market.Models.Domain.BankTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("market.Models.Domain.FinancialAccount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("market.Models.Domain.FinancialDocument", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("market.Models.Domain.FinancialTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("market.Models.Domain.ProductImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("market.Models.Domain.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("market.Models.Domain.Brand", b =>
                {
                    b.HasOne("market.Data.Domain.File", "LogoFile")
                        .WithOne()
                        .HasForeignKey("market.Models.Domain.Brand", "LogoFileId");
            ...
            modelBuilder.Entity("market.Models.Domain.FinancialAccount", b =>
                {
                    b.HasOne("market.Models.Domain.Customer", "Customer")
                        ...
                        .HasForeignKey("market.Models.Domain.FinancialAccount", "CustomerId");

                    b.HasOne("market.Models.Domain.Panel", "Panel")
                        .WithOne("FinancialAccount")
                        .HasForeignKey("market.Models.Domain.FinancialAccount", "PanelId");
            ...
            modelBuilder.Entity("market.Models.Domain.FinancialTransaction", b =>
                {
                    b.HasOne("market.Models.Domain.FinancialAccount", "FinancialAccount")
                        .WithMany("FinancialTransactions")
                        .HasForeignKey("FinancialAccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("market.Models.Domain.FinancialDocument", "FinancialDocument")
                        .WithMany("FinancialTransactions")
            ...
            modelBuilder.Entity("market.Models.Domain.Order", b =>
                {
                    ...
                    b.HasOne("market.Models.Domain.FinancialDocument", "FinancialDocument")
                        .WithOne("Order")
                        .HasForeignKey("market.Models.Domain.Order", "FinancialDocumentId");
            ...
            modelBuilder.Entity("market.Models.Domain.Product", b =>
                {
                    b.HasOne("market.Models.Domain.Brand", "Brand")
                        .WithMany()
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("market.Models.Domain.Category", "Category")
                        .WithMany()
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("market.Models.Domain.ProductImage", b =>
                {
                    b.HasOne("market.Data.Domain.File", "File")
                        .WithOne()
                        .HasForeignKey("market.Models.Domain.ProductImage", "FileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("market.Models.Domain.User", b =>
                {
                    b.HasOne("market.Data.Domain.File", "AvatarFile")
                        .WithOne()
                        .HasForeignKey("market.Models.Domain.User", "AvatarFileId");
